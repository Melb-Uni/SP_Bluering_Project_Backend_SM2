...
3. Access the google drive link and download prod.py and dev.py (https://drive.google.com/drive/folders/1AvH8nSIdgpFkoqMevrh13s944urW1Nqt?usp=sharing)
4. Place both the files in TeamSPBackend/Settings folder.
...
6. create MySQL tables `python manage.py migrate`
